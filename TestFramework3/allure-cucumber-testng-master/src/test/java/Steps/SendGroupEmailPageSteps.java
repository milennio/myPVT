...
public class SendGroupEmailPageSteps {
  private static final Logger logger = Logger.getLogger(SendGroupEmailPageSteps.class);
  ...
  public void iComposeLetter() throws Throwable {
    sendGroupEmailPage.composeLetter("lina.baikova@bk.ru", "nothing new", "like really nothing");
  }
